...
const createPlugin = ({
  ...
  if (!title || !author || !onLoad && !onStart && !patches)
    return console.error(`ERROR: Plugin does not have a title, author, or executable functions.`);
  let plugin = {
    title,
...
const loadPlugins = async () => {
  ...
  await Promise.all(Object.values(/* @__PURE__ */ Object.assign({
    ...
    "../plugins/bazaarsniper/index.js": __vite_glob_0_1,
    "../plugins/betterchat/index.js": __vite_glob_0_2,
    "../plugins/blookutils/index.js": __vite_glob_0_3,
    "../plugins/chatonclans/index.js": __vite_glob_0_4,
